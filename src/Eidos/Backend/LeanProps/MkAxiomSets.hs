...
-- in 'Eidos.Pipeline.MkAxiomSets'.  The mereological-to-logical translation
-- of user-written propositions is performed by 'Eidos.FromSyntax' before
...
import qualified Eidos.Pipeline.AxiomSet as PA
import           Eidos.Pipeline.MkAxiomSets (theoryBlocks)
