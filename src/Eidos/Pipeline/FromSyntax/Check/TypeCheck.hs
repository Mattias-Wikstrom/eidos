...
module Eidos.Pipeline.FromSyntax.Check.TypeCheck
...
import qualified Eidos.Pipeline.FromSyntax.IR as IR (EntityClass)
...
--
-- __Relationship to 'ExprType'\/'MereologicalSubtype' in "Eidos.Pipeline.FromSyntax.IR"__:
...
-- The bridge is 'getResolvedTermType' in "Eidos.Pipeline.FromSyntax.FromSyntax", which converts
