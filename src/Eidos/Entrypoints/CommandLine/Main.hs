module Eidos.Entrypoints.CommandLine.Main where

import           System.Environment (getArgs)
import           System.Exit        (exitFailure, exitSuccess)
import qualified System.IO          as IO

import           Eidos.Pipeline.Parse.Parser       (parseFile)
import           Eidos.Pipeline.FromSyntax.FromSyntax   (buildTheoryFromFile, buildTheoryPure,
                                     buildTheoryFromResolved)
import           Eidos.Pipeline.Resolution.Resolution   (resolveExternalRefs)
