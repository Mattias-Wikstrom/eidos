...
echo "=========================================="
echo "All theories in theories/ directory"
echo "=========================================="
echo
...
for theory in theories/*.theory; do
    if [ -f "$theory" ]; then
        ...
        echo -n ""
	echo -n "Showing contents of $filename... "

	cat "$theory"
        
        echo -n ""
	#echo -n "Showing compilation result for $filename... "

        #cabal run eidos-parser -- "${RUN_ARGS[@]}" "$theory"
